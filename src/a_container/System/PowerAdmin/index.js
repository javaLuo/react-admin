...
import { addPower, getMenus, upPower, delPower, getPowerDataByMenuId } from '../../../a_action/sys-action';
    ...
    onOk = () => {
        ...
        form.validateFields([
            ...
            if (this.state.operateType === 'add') { // 新增
                this.props.actions.addPower(params).then((res) => {
                ...
                this.props.actions.upPower(params).then((res) => {
                    if(res.status === 200) {
